...
class Letter extends Model
{
    ...
    public function scopePerdir($query)
    {
        return $this->scopeType($query, LetterType::PERDIR);
    }

    public function scopeKpts($query)
    {
        return $this->scopeType($query, LetterType::KPTS);
    }

    public function scopePemberitahuan($query)
    {
        return $this->scopeType($query, LetterType::PEMBERITAHUAN);
    }

    public function scopePakta($query)
    {
        return $this->scopeType($query, LetterType::PAKTA);
    }
    
    public function scopeNotulen($query)
    {
        return $this->scopeType($query, LetterType::NOTULEN);
    }
