    ...
    <div class="card-body">
        <div class="d-flex justify-content-between flex-column flex-sm-row">
            <div>
                ...
                @elseif ($letter->type == 'perdir')
                    <a href="{{ route('transaction.perdir.show', $letter) }}" class="fw-bold">{{ $letter->reference_number }}</a>
                @elseif ($letter->type == 'kpts')
                    <a href="{{ route('transaction.kpts.show', $letter) }}" class="fw-bold">{{ $letter->reference_number }}</a>
                @elseif ($letter->type == 'pemberitahuan')
                    <a href="{{ route('transaction.pemberitahuan.show', $letter) }}" class="fw-bold">{{ $letter->reference_number }}</a>
                @elseif ($letter->type == 'pakta')
                    <a href="{{ route('transaction.pakta.show', $letter) }}" class="fw-bold">{{ $letter->reference_number }}</a>
                @elseif ($letter->type == 'notulen')
                    <a href="{{ route('transaction.notulen.show', $letter) }}" class="fw-bold">{{ $letter->reference_number }}</a>
                @endif
                </small>
            </div>
