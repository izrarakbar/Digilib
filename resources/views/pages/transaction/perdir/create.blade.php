...
@section('content')
    <x-breadcrumb
        :values="[__('menu.transaction.menu'), __('menu.digital.surperdir'), __('menu.general.create')]">
    </x-breadcrumb>

    <div class="card mb-4">
        <form action="{{ route('transaction.perdir.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="card-body row">
                <input type="hidden" name="type" value="perdir">
