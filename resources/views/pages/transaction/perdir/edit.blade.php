...
@section('content')
    <x-breadcrumb
        :values="[__('menu.transaction.menu'), __('menu.digital.surperdir'), __('menu.general.edit')]">
    </x-breadcrumb>

    <div class="card mb-4">
        <form action="{{ route('transaction.perdir.update', $data) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
