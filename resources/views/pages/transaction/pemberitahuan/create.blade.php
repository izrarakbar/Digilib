...
@section('content')
    <x-breadcrumb
        :values="[__('menu.transaction.menu'), __('menu.digital.surpemberitahuan'), __('menu.general.create')]">
    </x-breadcrumb>

    <div class="card mb-4">
        <form action="{{ route('transaction.pemberitahuan.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
