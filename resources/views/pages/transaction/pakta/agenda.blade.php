...
@section('content')
    <x-breadcrumb
        :values="[__('menu.agenda.menu'), __('menu.digital.surpakta')]">
    </x-breadcrumb>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <a
                                        href="{{ route('agenda.pakta.print') . '?' . $query }}"
                                        target="_blank"
                ...
                @if($data)
                    ...
                    @foreach($data as $agenda)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('transaction.pakta.show', $agenda) }}">{{ $agenda->reference_number }}</a>
                            </td>
                            <td>{{ $agenda->to }}</td>
