...
@section('content')
    <x-breadcrumb
        :values="[__('menu.transaction.menu'), __('menu.digital.surnotulen'), __('menu.general.edit')]">
    </x-breadcrumb>

    <div class="card mb-4">
        <form action="{{ route('transaction.notulen.update', $data) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
